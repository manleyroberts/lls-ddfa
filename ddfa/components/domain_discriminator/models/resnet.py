...
Modifications by Wouter Van Gansbeke, Simon Vandenhende: https://github.com/wvangansbeke/Unsupervised-Classification.
Licensed under the CC BY-NC 4.0 license (https://creativecommons.org/licenses/by-nc/4.0/)

Modifications by Pranav Mani and Manley Roberts
"""

class ResNetForSCANBaseline(nn.Module):
    def __init__(self, block, num_blocks, in_channel=3, zero_init_residual=False):
        super(ResNetForSCANBaseline, self).__init__()
        self.in_planes = 64
...
class ResNetwithInitialisationsForSCANBaseline(ResNetForSCANBaseline): 
    def __init__(self, block, num_blocks, num_classes=10):
        super(ResNetwithInitialisationsForSCANBaseline,self).__init__(block,num_blocks)
...
def ResNet18_for_SCAN(**kwargs):
    return {'backbone': ResNetwithInitialisationsForSCANBaseline(BasicBlock, [2, 2, 2, 2], **kwargs), 'dim': 512}
